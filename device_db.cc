...
Status DeviceDb::Load() {
  ...
  /*	device_db_[0x5c60] = DeviceInfo{"18F24K50", 0x5c60, 0x4000, 8, 0x200000, 14, 0x300000, 256,
     0xf00000, 64, 64};
     ...
     256, 0xf00000, 64, 64};*/
  device_db_[0x5c00] = DeviceInfo{"18F45K50",
                                  0x5c00,
                                  0x8000,
                                  8,
                                  0x200000,
                                  ...
                                  {0x0084},
                                  {0x0082},
                                  {0x0084, 0x0180, 0x0280, 0x0480, 0x0880},
                                  MilliSeconds(15) + MicroSeconds(200)};
  /*	device_db_[0x5c80] = DeviceInfo{"18LF45K50", 0x5c80, 0x8000, 8, 0x200000, 14, 0x300000, 256,
     0xf00000, 64, 64};
